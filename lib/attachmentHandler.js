...
exports.checkAndHandleDuplicateOnThread = function( parsedMailAttachment, parsedMail, mail, callback ) {
  ...
  AttachmentModel.findOne(duplicateSearchCriteria, function(err, foundAttachment) {
    if ( err ) {
      ...
      //winston.info('attachmentHandler: checkAndHandleDuplicateOnThread: duplicate found on later message');
      ...
      //winston.info('attachmentHandler: checkAndHandleDuplicateOnThread: duplicate found on earlier message');
      callback(null, true);
    }
  });
}
...
exports.updateAttachmentForMail = function( attachment, mail, parsedMailAttachment, callback ) {
  ...
  var sender = mailUtils.copySender( mail.sender );
