      ...
      if ( err ) {
        ...
        attachmentHandler.saveAttachment(attachment, function (err) {
          if (err) {
            ...
            indexingHandler.createIndexingJobForAttachment (attachment);
            ...
            attachmentHandler.saveAttachment( attachment, function (err) {
              if (err) {
                ...
                if ( ! attachment.isPromoted ) {
                  ...
                  indexingHandler.createIndexingJobForResource (attachment, mail);
                  indexingHandler.createIndexingJobForResourceMeta (attachment)
