      ...
      if ( err ) {
        ...
        attachmentHandler.saveAttachment(attachment, function (err) {
          if (err) {
            ...
            indexingHandler.indexResourceMetadata(attachment, mail, fileContentId, isLink, function (err) {
              callback(err);
            });
          }
        });
      ...
      attachmentHandler.updateAttachmentForMail( foundAttachment, mail, parsedMailAttachment,
        function(err, updatedAttachment) {
          if ( err ) {
            ...
            indexingHandler.updateResourceMetadata (updatedAttachment, mail, fileContentId, isLink, function (err) {
