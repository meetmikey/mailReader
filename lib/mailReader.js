...
var conf = require(serverCommon + '/conf')
  ...
  , azureUtils = require(serverCommon + '/lib/azureUtils')
...
exports.saveMailBody = function( parsedMail, mail, callback ) {
  ...
  if ( mail.indexState && ( mail.indexState != 'none' ) ) {
    ...
    var buffer = mailBody.toString();
    var azurePath = azureUtils.getMailBodyPath( mail );
    var options = {};
    var useGzip = true;

    azureUtils.putBuffer( buffer, azurePath, options, useGzip, callback );
