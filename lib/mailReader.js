...
exports.handleMailMessage = function(messageString, callback) {
  ...
  // TODO: remove hack!!! user has been deleted but jobs exist
  if (userId == '52015387bf54e99127011dfb') {
    callback ();
    return;
  }
...
exports.runMailProcessor = function( parsedMail, mailId, userId, callback ) {
  mailReader.processMail( parsedMail, mailId, userId, function(err, mail, mailReaderState) {
