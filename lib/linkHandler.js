...
exports.handleThreadDuplicateUpdate = function( link, mail, callback ) {
  ...
  linkHandler.updateLinkToMail( link, mail, function(err) {
    if ( err ) {
      callback( err );


      //get linkInfo and update from that.
...
exports.checkAndMarkLinkPromoted = function( link, mail, isLinkAlreadInDB, callback ) {
...
exports.handleNewURLOnThread = function( url, mail, callback ) {
  ...
  linkHandler.buildAndSaveLink( url, mail, function( err, link ) {
    if ( err ) {
      callback( err );
