...
exports.handleValidURL = function(url, mail, callback) {
  ...
  if ( ! linkHandler.isPromotable( url, mail ) ) {
...
exports.isPromotable = function( url, mail ) {
...
exports.updateLinkForMail = function( link, url, mail, callback ) {
  ...
  var updateSet = { $set: {
      mailId: mail._id
    , url: url
    , urlHash: urlUtils.getComparableURLHash( url )
...
exports.addLinkInfoToLink = function( linkInfo, link ) {
  ...
  if ( ! link ) { winston.doMissingParamError('link'); return null; }
